<script lang="ts">
    import ProfileManagementListRow from "$lib/presentation/components/profile/ProfileManagementListRow.svelte";
    import { type ProfileManagementRow } from "$lib/presentation/logic/profileManagementPageState";
