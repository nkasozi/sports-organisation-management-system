                    ...
                    {#each paginated_team_fixtures as fixture}
                        ...
                        {@const did_lose =
                            ...
                            ((is_home && home_score < away_score) ||
                                (!is_home && away_score < home_score))}
                        <div
                            class={`p-3 rounded-lg border transition-colors ${fixture.status === "completed" ? (did_win ? "border-green-200 bg-green-50 dark:border-green-800/50 dark:bg-green-900/10" : did_lose ? "border-red-200 bg-red-50 dark:border-red-800/50 dark:bg-red-900/10" : "border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800") : fixture.status === "in_progress" ? "border-red-300 bg-red-50 dark:border-red-700 dark:bg-red-900/20" : "border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800"}`}
                        >
