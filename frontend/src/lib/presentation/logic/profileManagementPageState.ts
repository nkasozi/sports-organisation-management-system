...
const PROFILE_MANAGEMENT_ACTIONS = {
  READ: "read",
  CREATE: "create",
  UPDATE: "update",
  DELETE: "delete",
...
const PROFILE_MANAGEMENT_VISIBILITY_CLASS_BY_VALUE: Record<string, string> = {
  public:
...
const PROFILE_MANAGEMENT_STATUS_CLASS_BY_VALUE: Record<string, string> = {
  active:
    "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400",
  inactive:
    "bg-accent-100 text-accent-700 dark:bg-accent-700 dark:text-accent-300",
