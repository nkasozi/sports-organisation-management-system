...
export async function initialize_fixture_lineup_create_page(
  ...
  return {
    ...
    current_step_index: determine_initial_wizard_step({
      ...
      organization_id:
        get_authorization_preselect_values(params.current_auth_profile)
          .organization_id || params.form_organization_id,
      has_selected_organization: Boolean(reference_data.selected_organization),
    }),
  };
}
