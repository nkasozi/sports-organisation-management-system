...
export interface FixtureDetailsSetupFilter {
  ...
  official_id?: ScalarValueInput<FixtureDetailsSetup["assigned_officials"][number]["official_id"]>;
  role_id?: ScalarValueInput<FixtureDetailsSetup["assigned_officials"][number]["role_id"]>;
